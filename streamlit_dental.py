...
col1, spacer, col2 = st.columns([2.4, 0.0001, 2])  # Adjust the size of columns: 8 for content, 1 for space
...
col3, spacer2, col4 = st.columns([2.4, 0.0001, 2])  # Adjust the size of columns: 8 for content, 1 for space
