...
col1, spacer, col2 = st.columns([2.2, 0, 2])  # Adjust the size of columns: 8 for content, 1 for space
...
col3, spacer2, col4 = st.columns([2.2, 0, 2])  # Adjust the size of columns: 8 for content, 1 for space
